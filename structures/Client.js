...
module.exports = class ChillaxClient extends CommandoClient {
	constructor(options) {
		super(options);
		...
		this.webhook = new WebhookClient(CHILLAX_WEBHOOK_ID, CHILLAX_WEBHOOK_TOKEN, { disableMentions: 'everyone' });
